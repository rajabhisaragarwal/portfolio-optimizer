...
if run_button:
    ...
    fig.add_trace(go.Scatter(
        ...
        mode="markers",
        marker=dict(size=18, color="#2ECC71", symbol="circle", opacity = 0.75, line=dict(color="white", width=1.5)),
    ...
    fig.add_trace(go.Scatter(
        ...
        mode="markers",
        marker=dict(size=18, color="#3498DB", symbol="circle", opacity = 0.75, line=dict(color="white", width=1.5)),
    ...
    fig.add_trace(go.Scatter(
        ...
        mode="markers",
        marker=dict(size=18, color="#E74C3C", symbol="circle", opacity = 0.75, line=dict(color="white", width=1.5)),
