...
if run_button:
    ...
    fig.add_trace(go.Scatter(
        ...
        mode="markers",
        marker=dict(size=22, color="#2ECC71", symbol="circle", opacity = 0.9, line=dict(color="white", width=1.5)),
    ...
    fig.add_trace(go.Scatter(
        ...
        mode="markers",
        marker=dict(size=18, color="#3498DB", symbol="diamond", opacity = 0.9, line=dict(color="white", width=1.5)),
    ...
    fig.add_trace(go.Scatter(
        ...
        mode="markers",
        marker=dict(size=16, color="#E74C3C", symbol="star", opacity = 0.9, line=dict(color="white", width=1.5)),
